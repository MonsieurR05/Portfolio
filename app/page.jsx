    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 md:px-8 pt-16 pb-16 relative overflow-hidden">
      ...
      <div className="max-w-4xl w-full mx-auto text-center">
        <div className="space-y-8">
          ...
          >
            <div className="space-y-4">
              <h1 className="text-6xl md:text-8xl lg:text-9xl font-bold leading-[1.1] tracking-tight overflow-visible pb-4">
                <span className="block text-muted-foreground/60 text-3xl md:text-4xl lg:text-5xl mb-2">
          ...
          >
            <h2 className="text-lg md:text-xl font-bold mb-3 text-foreground">Technologies</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2 max-w-2xl mx-auto">
              <div className="bg-card border border-border rounded-lg p-2 hover:border-primary hover:shadow-lg hover:shadow-primary/10 transition-all duration-300 hover:-translate-y-1">
                <h3 className="text-xs font-semibold text-primary mb-1.5">Frontend</h3>
                <div className="flex flex-wrap gap-1">
                  {techStack.frontend.map((tech) => (
                    <span
                      key={tech}
                      className="px-1.5 py-0.5 bg-background border border-border rounded text-xs font-medium hover:border-primary hover:bg-primary/5 transition-all duration-200 cursor-default hover:scale-105"
                    >
                      {tech}
                    </span>
                  ))}
              ...
              <div className="bg-card border border-border rounded-lg p-2 hover:border-primary hover:shadow-lg hover:shadow-primary/10 transition-all duration-300 hover:-translate-y-1">
                <h3 className="text-xs font-semibold text-primary mb-1.5">Backend</h3>
                <div className="flex flex-wrap gap-1">
              ...
              <div className="bg-card border border-border rounded-lg p-2 hover:border-primary hover:shadow-lg hover:shadow-primary/10 transition-all duration-300 hover:-translate-y-1">
                <h3 className="text-xs font-semibold text-primary mb-1.5">Other</h3>
                <div className="flex flex-wrap gap-1">

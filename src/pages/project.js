  ...
  return (
    ...
    border-4 border-solid border-dark bg-dark p-6 relative dark:bg-dark bg-dark dark:border-light border-light xs:p-4">
      ...
      <div className="w-full flex flex-col items-start justify-between mt-4">
        <span className="text-primary font-medium text-xl dark:text-primaryDark text-primaryDark lg:text-lg md:text-base">
          {type}
        ...
        <Link
            ...
            dark:bg-light bg-light dark:text-dark text-dark
            sm:px-4 sm:text-base
            "
          >
           Visit
  ...
  return (
    <>
      ...
      <main className="w-full mb-16 flex flex-col items-center justify-center ">
        ...
        className="lg:text-7xl sm:mb-8 sm:top-14 sm:text-6xl xs:text-4xl sm:relative text-white font-Poppins font-bold tracking-wider text-8xl relative left-1/2 top-3 transform -translate-x-1/2 -translate-y-1/2 text-center"
        />

  ...
  return (
    <>
      ...
      <main className="w-full mb-16 flex flex-col items-center justify-center ">
        ...
        className="lg:text-7xl sm:mb-8 sm:top-10 sm:text-6xl xs:text-4xl sm:relative text-white font-Poppins font-bold tracking-wider text-8xl relative left-1/2 top-3 transform -translate-x-1/2 -translate-y-1/2 text-center"
        />

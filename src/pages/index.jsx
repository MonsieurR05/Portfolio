...
import profilePic from "../../src/Images/profile/Rahul2.png";
        ...
        <Layout className='pt=0' >
          <div className="flex items-center justify-between w-full">
            <div className="relative rounded-full w-80 h-80 flex ml-auto mr-auto mt-50 overflow-hidden ">
              <Image src={profilePic} layout ="fill" objectFit='cover' alt="Me"   />
            </div>
            ...
            <p className='my-4 font-medium line-clamp-6  '>
            As a Software Developer, I'm learning and experimenting to develop new ideas.
            </p>
            <p className='font-medium text-1xl'>Explore my latest projects and projects under development.</p>
            </div>
          </div>
        </Layout>
      </main>

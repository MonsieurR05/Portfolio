...
import Picture from '../Images/profile/Rahul.png';  
...
const About = () => {
    ...
    <>
      ...
      <main className='flex w-full flex-col items-center justify-center'>
        ...
        <TextAnimation text="Creativity and Imagination!" className='mb-16'/>
       
        <div className='grid w-full grid-cols-8 gap-16'>
            <div className='col-span-3 flex flex-col items-start justify-start'>
                <h2 className='relative top-11 mb-4 text-lg font-bold uppercase text-light/75'>About Me</h2>
                <p className='font-medium relative top-11 '>
                ...
                <p className='my-4 font-medium relative top-11'>

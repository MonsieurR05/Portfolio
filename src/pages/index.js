        ...
        <Layout className='pt-0 ' >
          <div className="flex flex-col justify-center items-center w-full lg:flex-col relative bottom-3">
            ...
            <div className='w-4/5 sm:w-1/2 mt-5 flex flex-col items-center'>
              <h1 className='my-1 text-5xl sm:text-xl md:text-5xl text-gray-500 font-semibold font-mono relative'>Rahul &#8226; &#9794;</h1>

              <h1 className='my-3 text-5xl sm:text-xl md:text-5xl text-left font-bold relative '>
                <TypeWriter
                  options={{
              ...
              <h1 className="text-5xl font-bold text-light mt-8 relative top-4 sm:text-3xl ">&#60;&#47;Explore&#62;</h1> 
              <div className="flex justify-center gap-12 mt-14 flex-wrap">
                <div className="w-96 h-48 border-2 border-light rounded-2xl lg:mb-0 sm:w-56 sm:h-42 block box-link"></div>
                <div className="w-96 h-48 border-2 border-light rounded-2xl lg:mb-0  sm:w-56 sm:h-42 block box-link"></div>
                <div className="w-96 h-48 border-2 border-light rounded-2xl lg:mb-0  sm:w-56 sm:h-42 block box-link"></div>
              </div>
            </div>

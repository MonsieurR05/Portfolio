...
const NavBar = () => {
  ...
  return (
    ...
    text-light  dtext-light relative z-10 lg:px-16 md:px-12 sm:px-8">
  ...
  <nav className="flex items-center justify-center square relative top-3 border-2 border-light h-[100px] w-[1150px] rounded-xl 2xl:w-[1100px]">
...
<nav className="flex items-center flex-col justify-center">
        ...
        <div className="absolute left-[24%] top-[31%]  translate-x-[-50%] sm:absolute sm:left-[50%] 2xl:right-[55%]">
        <Logo/>
      </div>
    </header>
  );
